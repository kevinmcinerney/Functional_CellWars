...
class GameSpec extends PlaySpec with PrivateMethodTester {
  ...
  val Adj = Vector.fill[Vector[Int]](rCells_t1.length)(Vector.fill[Int](rCells_t1.length)(0))

  val board_t1 = Board(rCells_t1, Vector(), Adj)
  println("board_t1")
  board_t1.print()
  println()
...
//  Adj(4)(3) = 1
  ...
  val board_t2 = Board(rCells_t2, Vector(VCell(2, 3, 8, 10, 1)), a2)
  println("board_t2: cell3 right")
  board_t2.print()
  println()

  val board_t3 = Board(rCells_t3, Vector(VCell(3, 3, 8, 10, 1)), a2)
...
//  Adj(6)(5) = 1
  ...
  val board_t4 = Board(rCells_t4, Vector(VCell(3, 0, 12, 12, 1)), a3)
